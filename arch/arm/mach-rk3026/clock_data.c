...
static const struct apll_clk_set apll_clks[] = {
	_APLL_SET_CLKS(1608, 1, 67, 1, 1, 1, 0, 81, 41, 41, 21, 21),
	_APLL_SET_CLKS(1584, 1, 66, 1, 1, 1, 0, 81, 41, 41, 21, 21),
	_APLL_SET_CLKS(1560, 1, 65, 1, 1, 1, 0, 81, 41, 41, 21, 21),
	_APLL_SET_CLKS(1536, 1, 64, 1, 1, 1, 0, 81, 41, 41, 21, 21),
	_APLL_SET_CLKS(1512, 1, 63, 1, 1, 1, 0, 81, 41, 41, 21, 21),
	_APLL_SET_CLKS(1488, 1, 62, 1, 1, 1, 0, 81, 41, 41, 21, 21),
	_APLL_SET_CLKS(1464, 1, 61, 1, 1, 1, 0, 81, 41, 41, 21, 21),
	_APLL_SET_CLKS(1440, 1, 60, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1416, 1, 59, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1392, 1, 58, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1368, 1, 57, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1344, 1, 56, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1320, 1, 55, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1296, 1, 54, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1272, 1, 53, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1248, 1, 52, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1200, 1, 50, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1104, 1, 46, 1, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS(1008, 1, 84, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 984, 1, 82, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 960, 1, 80, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 936, 1, 78, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 912, 1, 76, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 888, 1, 74, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 864, 1, 72, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 840, 1, 70, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 816, 1, 68, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 696, 1, 58, 2, 1, 1, 0, 41, 41, 41, 21, 21),
	_APLL_SET_CLKS( 600, 1, 75, 3, 1, 1, 0, 41, 21, 41, 21, 21),
	_APLL_SET_CLKS( 504, 1, 63, 3, 1, 1, 0, 41, 21, 41, 21, 21),
	_APLL_SET_CLKS( 408, 1, 68, 2, 2, 1, 0, 41, 21, 41, 21, 21),
	_APLL_SET_CLKS( 312, 1, 52, 2, 2, 1, 0, 41, 21, 41, 21, 21),
	_APLL_SET_CLKS( 216, 1, 72, 4, 2, 1, 0, 41, 21, 41, 21, 21),
	_APLL_SET_CLKS( 96, 1, 64, 4, 4, 1, 0, 21, 21, 41, 21, 21),
	_APLL_SET_CLKS(   0, 1, 0, 1, 1, 1, 0, 21, 21, 41, 21, 21),
};
...
static int pll_clk_set_postdiv(unsigned long fout_hz, u32 *postdiv1, u32 *postdiv2, u32 *foutvco)
{
...
GATE_CLK(ddrphy_src, ddr_pll_clk, DDRPHY_SRC);
GATE_CLK(ddrphy_gpll_src, general_pll_clk, DDRPHY_GPLL_SRC);
GATE_CLK(core_gpll, general_pll_clk, CORE_GPLL);
GATE_CLK(cpu_gpll, general_pll_clk, CPU_GPLL);
/*********ddr******/
...
static struct clk clk_ddr_pllsel = {
	.name		= "ddr_pllsel",
	.parent		= &ddr_pll_clk,
	.clksel_con	= CRU_CLKSELS_CON(26),
	CRU_SRC_SET(0x1, 8),
	CRU_PARENTS_SET(clk_ddr_pllsel_parents),
};

static struct clk clk_ddr_dll = {
	.name		= "ddr_dll",
	.parent		= &clk_ddr_pllsel,
	.mode		= gate_mode,
	.gate_idx	= CLK_GATE_DLL_DDR,
...
static struct clk *clk_core_pre_parents[2] = {&arm_pll_clk, &clk_core_gpll};
static struct clk clk_dll_core = {
	.name		= "dll_core",
	.parent		= &arm_pll_clk,
	.gate_idx	= CLK_GATE_DLL_CORE,
	.recalc		= clksel_recalc_div,
	.set_rate 	= clksel_set_rate_freediv,
...
static struct clk aclk_core_pre = {
	...
	.set_rate 	= clksel_set_rate_freediv,
	.clksel_con	= CRU_CLKSELS_CON(1),
	CRU_DIV_SET(ACLK_CORE_DIV_MASK, ACLK_CORE_DIV_SHIFT, 8),
};

/****************cpu*******************/

static struct clk *clk_cpu_div_parents[] = {&arm_pll_clk, &clk_cpu_gpll};
...
static struct clk hclk_vepu = {
	...
	.parent		= &aclk_vepu,
	.mode		= gate_mode,
	.gate_idx	= CLK_GATE_HCLK_VDPU,	// hclk_vdpu and hclk_vepu use the same gating
	.recalc		= clksel_recalc_fixed_div4,
};
static struct clk hclk_vdpu = {
	.name		= "hclk_vdpu",
	.parent		= &aclk_vepu,		// do not use aclk_vdpu as hclk_vepu/hclk_vdpu src
	.mode		= gate_mode,
...
/****************vio*******************/
// name: lcdc0_aclk
static struct clk *clk_aclk_lcdc_parents[]		= SELECT_FROM_2PLLS_CG;
static struct clk aclk_lcdc0_pre = {
	...
	CRU_DIV_SET(0x1f, 0, 32),
	CRU_SRC_SET(0x1, 7),
	CRU_PARENTS_SET(clk_aclk_lcdc_parents),
};
...
static struct clk hclk_disp_pre = {
	.name		= "hclk_disp_pre",
	.parent		= &general_pll_clk,
	.mode		= gate_mode,
	.gate_idx	= CLK_GATE_HCLK_DISP,
	.recalc		= clksel_recalc_div,
	.set_rate	= clksel_set_rate_freediv,
...
/****************timer*******************/
static struct clk *clk_timer0_parents[]		= {&xin24m, &pclk_periph_pre};
static struct clk *clk_timer1_parents[]		= {&xin24m, &pclk_periph_pre};
...
#endif
static struct clk *dclk_lcdc_parents[] = SELECT_FROM_2PLLS_CG;
...
static struct clk *dclk_ebc_parents[] = SELECT_FROM_2PLLS_CG;

static int clksel_set_ebc_rate_freediv(struct clk *clk, unsigned long rate)
{
	u32 div = 0;
	int freq;
	int new_rate;
	if(rate >= 50000000 && rate <= 60000000)
		div = 8;
	else if(rate > 60000000 && rate <= 68000000)
		div = 7;
	else if(rate > 68000000 && rate <= 80000000)
		div = 6;
	else if(rate > 80000000 && rate <= 96000000)
		div = 5;
	else if(rate > 96000000 && rate <= 120000000)
		div = 4;
	else
		div = 3;
	for(freq = 700000000;freq > 400000000;){
		new_rate = freq / (div + 1);
		if (new_rate == rate){
			clk_set_rate_nolock(&codec_pll_clk, freq);
			set_cru_bits_w_msk(div, clk->div_mask, clk->div_shift, clk->clksel_con);
...
static struct clk dclk_ebc = {
	.name		= "dclk_ebc",
	.parent		= &codec_pll_clk,//&general_pll_clk,
	.mode		= gate_mode,
	.gate_idx	= CLK_GATE_DCLK_EBC_SRC,
	.recalc		= clksel_recalc_div,
	//.set_rate	= clkset_rate_freediv_autosel_parents,
	.set_rate	= clksel_set_ebc_rate_freediv,//clksel_set_rate_freediv,
	.clksel_con	= CRU_CLKSELS_CON(23),
	CRU_DIV_SET(0xff, 8, 256),
	CRU_SRC_SET(0x1, 0),
	CRU_PARENTS_SET(dclk_ebc_parents),
};
/****************gps*******************/
#if 0
...
/****************spi*******************/
static struct clk *clk_spi_parents[]		= SELECT_FROM_2PLLS_CG;
...
GATE_CLK(hclk_crypto, hclk_periph_pre, HCLK_CRYPTO);
...
GATE_CLK(hclk_emem_peri, hclk_periph_pre, HCLK_EMEM_PERI);
...
GATE_CLK(hclk_lcdc0, hclk_disp_pre, HCLK_LCDC0);
GATE_CLK(hclk_lcdc1, hclk_disp_pre, HCLK_LCDC1);
GATE_CLK(hclk_iep, hclk_disp_pre, HCLK_IEP);
GATE_CLK(hclk_vio_bus, hclk_disp_pre, HCLK_VIO_BUS);
GATE_CLK(hclk_cif0, hclk_disp_pre, HCLK_CIF);
GATE_CLK(hclk_ebc, hclk_disp_pre, HCLK_EBC);
...
static struct clk_lookup clks[] = {
	...
	CLK_GATE_NODEV(ddrphy_src),
	CLK_GATE_NODEV(ddrphy_gpll_src),
	CLK_GATE_NODEV(core_gpll),
	CLK_GATE_NODEV(cpu_gpll),
	CLK(NULL, "ddr_pllsel", &clk_ddr_pllsel),
	CLK(NULL, "ddrdll", &clk_ddr_dll),
	...
	CLK_GATE_NODEV(hclk_lcdc1),
	CLK_GATE_NODEV(hclk_iep),
	CLK_GATE_NODEV(hclk_vio_bus),
	CLK_GATE_NODEV(hclk_cif0),
	CLK_GATE_NODEV(hclk_ebc),
