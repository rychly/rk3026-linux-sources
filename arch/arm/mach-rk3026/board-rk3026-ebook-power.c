...
static struct regulator_consumer_supply DC1SW1_data[] = {
		{
            .supply = "vwl_3v3",
		},
	};
...
static struct regulator_init_data axp_regl_init_data[] = {
	...
	[vcc_DC1SW1] = {
		...
		.num_consumer_supplies = ARRAY_SIZE(DC1SW1_data),
		.consumer_supplies = DC1SW1_data,
	},
	[vcc_ldoio0] = {
		.constraints = {
			.name = "axp22_ldoio0",
...
static struct axp_funcdev_info axp_regldevs[] = {
	{
		...
		.name = "axp22-regulator",
		.id = AXP22_ID_SW1,
		.platform_data = &axp_regl_init_data[vcc_DC1SW1],
	}, {
		.name = "axp22-regulator",
		.id = AXP22_ID_LDOIO0,
