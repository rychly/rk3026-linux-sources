...
static struct rkcamera_platform_data new_camera[] = { 
   new_camera_device_ex(RK29_CAM_SENSOR_HM5065,
				back,
				0,
				INVALID_VALUE,
				INVALID_VALUE,
				...
				INVALID_VALUE,
				RK30_PIN3_PB4,
				CONS(RK29_CAM_SENSOR_HM5065,_PWRDN_ACTIVE),
				1,
				CONS(RK29_CAM_SENSOR_HM5065,_FULL_RESOLUTION),
				0x00,
				3,
				100000,
				CONS(RK29_CAM_SENSOR_HM5065,_I2C_ADDR),
				0,
				24),				
...
#define CONFIG_SENSOR_01 RK29_CAM_SENSOR_HM5065                     /* back camera sensor 1 */
...
#define CONFIG_SENSOR_480P_FPS_FIXED_01		15000//15fps
#define CONFIG_SENSOR_SVGA_FPS_FIXED_01		15000
#define CONFIG_SENSOR_720P_FPS_FIXED_01		30000//30fps
...
static void rk_cif_power(struct rk29camera_gpio_res *res,int on)
{
	...
	ldo_28 = regulator_get(NULL, "ricoh_ldo3");	// vcc28_cif
   ...
   //	printk("%s set ldo2 vcc28_cif=%dmV end\n", __func__, regulator_get_voltage(ldo_28));
		regulator_put(ldo_28);

		regulator_set_voltage(ldo_18, 1800000, 1800000);
		//regulator_set_suspend_voltage(ldo_18, 1500000);
