...
static int alarm_suspend(struct platform_device *pdev, pm_message_t state)
{
	...
	if (wakeup_queue) {
		...
		set_normalized_timespec(&rtc_delta,
					...
					wall_time.tv_nsec);
#if defined(CONFIG_MACH_RK3026_TB) || defined(CONFIG_MACH_RK3026_E601) || defined(CONFIG_MACH_RK3026_T63)
		rtc_alarm_time = ktime_to_timespec(hrtimer_get_expires(&wakeup_queue->timer)).tv_sec;
#else
