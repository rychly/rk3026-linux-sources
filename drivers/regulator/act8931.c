...
static int act8931_reg_write(struct act8931 *act8931, char reg, const u16 src)
{
	mutex_lock(&act8931->io_lock);
	act8931_i2c_write(act8931->i2c, reg, 1, src);
...
1111            3.8
*/
static int act8931_sys_read(void)
{
	return act8931_reg_read(g_act8931, ACT_SYS_0);
}

void bat_low_clear(void)
{	
	int val = act8931_sys_read();
	if (val & MASK_SYSSTAT) {
		val = act8931_sys_read();
		DBG("batlow_irq_clear=0x%x\n",val);
	}
}

int batlow_irq_config(int syslev)
{
	int val;
	...
	val = 0|(((0<<7)&MASK_TRST)
             | ((1<<6)&MASK_SYSMODE)
             | ((1<<5)&MASK_SYSLEVMSK)
             | ((syslev<<0)&MASK_SYSLEV));
	bat_low_clear();
	act8931_reg_write(g_act8931,ACT_SYS_0, val );
	DBG("batlow_irq_config syslev=0x%x\n",syslev);
	return 0;
}
#endif
...
static int pmu_show(struct seq_file *s, void *unused)
{
	struct act8931 *act8931 = g_act8931;
	...
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_SYS_0, 
		act8931_reg_read(act8931, ACT_SYS_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_SYS_1, 
		act8931_reg_read(act8931, ACT_SYS_1));
	
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG1_0, 
		act8931_reg_read(act8931, ACT_REG1_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG1_1, 
		act8931_reg_read(act8931, ACT_REG1_1));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG1_2, 
		act8931_reg_read(act8931, ACT_REG1_2));
	
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG2_0, 
		act8931_reg_read(act8931, ACT_REG2_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG2_1, 
		act8931_reg_read(act8931, ACT_REG2_1));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG2_2, 
		act8931_reg_read(act8931, ACT_REG2_2));
	
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG3_0, 
		act8931_reg_read(act8931, ACT_REG3_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG3_1, 
		act8931_reg_read(act8931, ACT_REG3_1));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG3_2, 
		act8931_reg_read(act8931, ACT_REG3_2));

	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG4_0, 
		act8931_reg_read(act8931, ACT_REG4_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG4_1, 
		act8931_reg_read(act8931, ACT_REG4_1));

	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG5_0, 
		act8931_reg_read(act8931, ACT_REG5_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG5_1, 
		act8931_reg_read(act8931, ACT_REG5_1));
	
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG6_0, 
		act8931_reg_read(act8931, ACT_REG6_0));
	
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG7_0, 
		act8931_reg_read(act8931, ACT_REG7_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_REG7_1, 
		act8931_reg_read(act8931, ACT_REG7_1));

	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_APCH_0, 
		act8931_reg_read(act8931, ACT_APCH_0));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_APCH_1, 
		act8931_reg_read(act8931, ACT_APCH_1));
	seq_printf(s, "reg=0x%02x, value=0x%02x\n", ACT_APCH_2, 
		act8931_reg_read(act8931, ACT_APCH_2));
...
{
	return single_open(file, pmu_show, NULL);
}

static const struct file_operations pmu_operations = {
	.open		= pmu_open,
	.read		= seq_read,
	.llseek		= seq_lseek,
...
{
	proc_create("act8931", 0, NULL, &pmu_operations);
	return 0;
}
late_initcall(pmu_init);
#endif	/* DEBUG_FS */
