...
#define AXP22_SW(_id, min, max, step, vreg, shift, nbits, ereg, ebit)	\
	AXP_SW(AXP22, _id, min, max, step, vreg, shift, nbits, ereg, ebit)
...
static struct axp_regulator_info axp_regulator_info[] = {
	...
	AXP22_SW(1,	1600,		3400,		100,	DCDC1,	0,	5,	DC1SW1EN,7),//dc1sw1 for wifi 
};
